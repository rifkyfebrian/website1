...
<body>
    <div class="container-fluid">
        <video width="100%" autoplay muted>
            <source src="pexels-creativ-medium-5585555.mp4" type="video/mp4">
        </video>
        <div class="row">
            <div class="col-7">
                <img src="Untitled-1.png" width="100%" alt="">
            </div>
            <div class="col-4">
                <div class="kotak-luar">
                    <div class="kotak-login p-5">
                        <center><h1 class="mt-5">PERPUSTAKAAN SMK TARUNA BANGSA</h1></center>
                        <center><h3 class="mt-5">Silahkan Login</h3></center>
